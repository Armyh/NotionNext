...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一名空间规划师, Hi，我是一名创意工作者,Hi，我是一名生活美学家,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '大象研习社', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一名创意工作者👩‍💻', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.168199.xyz', // 网站地址
  ...
  COMMENT_TWIKOO_CDN_URL:
    ...
    'https://cdn.staticfile.net/twikoo/1.6.39/twikoo.min.js', // twikoo客户端cdn
